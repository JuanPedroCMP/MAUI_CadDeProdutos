...
namespace MauiAppCadProduto
{
    public partial class MainPage : ContentPage
    {
        ...
        private void AdicionarProduto_Clicked(object sender, EventArgs e)
        {
            ...
            {
                Produtos.Add(new Produto(nome, preco, descricao, dataVali, categoria, dataValiReal));
    ...
    public class Produto
    {
        ...
        public Produto(string nome, double preco, string descricao, string dataVali, string categoria, DateTime dataValiReal)
        {
